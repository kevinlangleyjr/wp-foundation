...
function wp_skeleton_scripts() {
	wp_enqueue_style( 'wp-skeletonstyle', get_stylesheet_uri() );

	wp_enqueue_script( 'wp-skeletonnavigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'wp-skeletonskip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
